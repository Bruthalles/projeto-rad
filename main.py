...
if __name__ == "__main__":
    ...
    membro.nome = input("digite nome do membro: ")
    membro.data_nascimento = input("digite data de nascimento: ")
    membro.email = input("digite email: ")
    membro.cpf = input("digite cpf: ")
